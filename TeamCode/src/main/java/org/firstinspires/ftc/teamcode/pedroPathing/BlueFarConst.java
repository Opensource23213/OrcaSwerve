...
public class BlueFarConst {
    ...
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .translationalPIDFCoefficients(new PIDFCoefficients(0.06, 0, 0.006, 0.03))
            .headingPIDFCoefficients(new PIDFCoefficients(.2, 0, 0.1, 0.03))
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(.35, 0, 0.12, 0.06, 0.07))
